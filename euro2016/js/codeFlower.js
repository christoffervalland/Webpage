var CodeFlower = function(selector, w, h) {
  ...
  .gravity(100).linkDistance(20).charge(-3000)
  .on("tick", this.tick.bind(this))
  /**.charge(function(d) { return d._children ? -d.size / 100 : -40; })
  .linkDistance(function(d) { return d.target._children ? 180 : 125; })**/
  .size([h, w]);
};
...
CodeFlower.prototype.update = function(json) {
  ...
  .attr("r", function(d) {
    ...
    if(size > 50){
      ...
      return d.children ? d.children.length * 10 : d.goals / 5
    }
  });
...
CodeFlower.prototype.click = function(d) {
  //User clicked a node, but I'm ignoring that since it's not any hidden data in this view!!
